...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.11.xcframework.zip",
			checksum: "8d4781995ee1b0bc20a048e6eb9db2f7feb34667a4be03c26bec0af45f9609e4"
		)
	]
)