...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.4.0-beta.18.xcframework.zip",
			checksum: "65dd38868fb7d83c9f0d78f58954470140cac9023e7cb29b6db9f005f1a5af82"
		)
	]
)