...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.11.xcframework.zip",
			checksum: "df7d275726e132604691938a5c5082bced452a5f0587363169bc6a0b695d9744"
		)
	]
)