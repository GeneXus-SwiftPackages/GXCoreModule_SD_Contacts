...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.4.0-beta.11.xcframework.zip",
			checksum: "31518601c235e8da4008eec9cea51854e12bd2c3ed9ae81eb1d6445f88af455a"
		)
	]
)