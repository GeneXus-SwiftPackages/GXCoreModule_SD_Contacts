...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.41.xcframework.zip",
			checksum: "e7e94f5105967221428764f71421202a94d160fa00f663b24a92600dfb578e17"
		)
	]
)