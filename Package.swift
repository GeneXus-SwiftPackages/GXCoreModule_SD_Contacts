...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-1.3.0-rc.1.xcframework.zip",
			checksum: "7e6c6a3186fe67e351e61744bb866a8fc4874f018d2e664ed65164a180f252ca"
		)
	]
)