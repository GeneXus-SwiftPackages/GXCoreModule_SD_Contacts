...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.22.xcframework.zip",
			checksum: "e4ccad283246a0f29870149166effb0851aa3b7b0421a46de268a88aeaa1c19c"
		)
	]
)