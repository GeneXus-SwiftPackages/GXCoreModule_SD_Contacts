...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.15.xcframework.zip",
			checksum: "4a5f54ce8cc9a0573f101ef762ce163e02adbdd95c0eff3182244cb6f7a0c293"
		)
	]
)