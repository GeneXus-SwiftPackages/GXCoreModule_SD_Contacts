...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-2.1.0-rc.25.xcframework.zip",
			checksum: "250f5ce579a32f8146c54d82d50c67afb71dc6cef7ca2b6dd4e98989375282e1"
		)
	]
)