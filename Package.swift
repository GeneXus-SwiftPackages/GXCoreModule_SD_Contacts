...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.0.0-beta.2.xcframework.zip",
			checksum: "e5e87d5379e321d86cf5d83e0d769a2906241398878b51493a0d46ea7ff110b3"
		)
	]
)