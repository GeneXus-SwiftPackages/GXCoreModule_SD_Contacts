...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.4.0-beta.16.xcframework.zip",
			checksum: "4d571594eb17a21c965a15d73858fe26f8dabdaefb14bad7e3d12daeea06447f"
		)
	]
)