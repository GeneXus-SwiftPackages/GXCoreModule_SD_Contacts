...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.1.0-beta.6.xcframework.zip",
			checksum: "a5b6953bfede6bec726bba7f529cb1ef262925fdf365d979febe231cb8e2efd3"
		)
	]
)