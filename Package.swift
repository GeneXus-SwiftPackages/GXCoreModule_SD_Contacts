...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.0.0-beta.47.xcframework.zip",
			checksum: "544080975f0fcd87bb76106fa3a191aab1188c78f394626659ed03cdcae069eb"
		)
	]
)