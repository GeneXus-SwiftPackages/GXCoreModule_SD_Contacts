...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.11.xcframework.zip",
			checksum: "66854337754a35c24a0093b24824c1de4d7e870b60ee8904d9740046fcfce2d8"
		)
	]
)