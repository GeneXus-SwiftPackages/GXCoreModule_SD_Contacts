...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-2.1.4.xcframework.zip",
			checksum: "a0bc59c2f6c93a98d10994a2b7c53f30e6c1579188b7fab08b2a1360ff914aa0"
		)
	]
)