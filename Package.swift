...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.3.0-beta.10.xcframework.zip",
			checksum: "9c36eaa591db9796ff885da71cff4e1bdd0c4bbf14666b16eea26d938633dbd0"
		)
	]
)