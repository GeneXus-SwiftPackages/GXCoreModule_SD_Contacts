...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.19.xcframework.zip",
			checksum: "b8fb49119e46f8c0a32464f0df007a9fa5943da83b6da6455df3170160464dba"
		)
	]
)