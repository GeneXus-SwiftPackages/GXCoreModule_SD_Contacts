...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-4.1.0-rc.24.xcframework.zip",
			checksum: "821f0a3cc299c85da32a314880e9a8830573279e140dba326b605bd291945cf9"
		)
	]
)