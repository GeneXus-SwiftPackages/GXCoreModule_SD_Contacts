...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.10.xcframework.zip",
			checksum: "80f2a5ff13719aea7ae38f8730922ab6362a9b05e2c7a1adf7b663460adc2a29"
		)
	]
)