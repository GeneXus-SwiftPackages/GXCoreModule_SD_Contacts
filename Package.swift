...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.0.0-beta.17.xcframework.zip",
			checksum: "94c84465ba6d65a1571665e53a3a9ac33d1d3e4257a2f6128cfac9f648d7a9d6"
		)
	]
)