...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-1.1.0-rc.5.xcframework.zip",
			checksum: "64f2b7f2d529614609e8d0e1aeb348ba3e96797ee454037e6b723e1245bb8faf"
		)
	]
)