...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.13.xcframework.zip",
			checksum: "09931ece6ce4980a6455340ce0be54baa3dc8ea449dc1e049620e13bcfc1baf0"
		)
	]
)