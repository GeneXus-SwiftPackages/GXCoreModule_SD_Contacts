...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.6.xcframework.zip",
			checksum: "25e24c626a1180f1869a54c19ec9eec76e96923fc2d9d01511b02e8af56be6b6"
		)
	]
)