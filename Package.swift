...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-4.0.7.xcframework.zip",
			checksum: "983d97c5aea27b76b055878014ab42f7f34c5e0378673e44ce35182787a542c8"
		)
	]
)