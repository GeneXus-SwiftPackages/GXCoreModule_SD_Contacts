...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-5.0.0-rc.1.xcframework.zip",
			checksum: "5f878be02c191bdf9e5f2c52bd85d96e206ccfa879f15d37a6b00be521a4f7e8"
		)
	]
)