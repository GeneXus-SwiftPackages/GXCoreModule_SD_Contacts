...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.6.xcframework.zip",
			checksum: "b65c5704e1063787ac9b1a7542b959354a21c198ae2eff1db8c1c4d20284464e"
		)
	]
)