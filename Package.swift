...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.30.xcframework.zip",
			checksum: "8b6a70359a3c3162174b9275b3bb9617d733845f0e3bca1ff59c6e932cab6fc9"
		)
	]
)