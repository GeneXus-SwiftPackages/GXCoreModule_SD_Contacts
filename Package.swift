...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.31.xcframework.zip",
			checksum: "895e0434ad57edf3ee2c2aa9bc424f005d5855ec1fae3aafbf9a6cf1942baf51"
		)
	]
)