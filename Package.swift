...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.29.xcframework.zip",
			checksum: "4faa6a345a55c2598fe2288f88297c5f78eb63165205c0246beb0cebf2f5fe83"
		)
	]
)