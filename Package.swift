...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-1.4.27.xcframework.zip",
			checksum: "4a127d1fed02aea9b53ab83289ba4d2c1df6ffe4ed82ebf5902217976de3b552"
		)
	]
)