...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.24.xcframework.zip",
			checksum: "15cb01d0697821f286828b51e3eb3ef0e40cce672e34d7b681ffcb11fc723a46"
		)
	]
)