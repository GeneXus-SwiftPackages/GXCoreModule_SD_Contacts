...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.0.0-beta.51.xcframework.zip",
			checksum: "5dd5994fabd9d90e0f45dcefbad82ac4e56e0769b3338b9ebb1b318b61c8de5f"
		)
	]
)