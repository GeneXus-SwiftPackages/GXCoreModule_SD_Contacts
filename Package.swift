...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.31.xcframework.zip",
			checksum: "a0d5bb2b39143618b6b58e504bae0253835963374d5b4b7f431540ea5646ba7e"
		)
	]
)