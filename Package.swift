...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.7.xcframework.zip",
			checksum: "7fda573feed1e98d2395cdd5f4ef173a4ec6ae5233de279975b75f90058c854a"
		)
	]
)