...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.17.xcframework.zip",
			checksum: "1a0589770c555c55186d0793582209e9ca845cc3d0d1ffc05cfed86db3c38887"
		)
	]
)