...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-2.0.0-rc.22.xcframework.zip",
			checksum: "f9e976201f7672bcaac751d04db7e78a45cc9ae0c24410129c7283eda838893b"
		)
	]
)