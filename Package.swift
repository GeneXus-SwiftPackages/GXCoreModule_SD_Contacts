...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.3.xcframework.zip",
			checksum: "fcab0cc84168f1a1333bd9ad258d6ed011c9d0e2f91e7ae1d6f6f5811f09e670"
		)
	]
)