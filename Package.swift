...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.12.xcframework.zip",
			checksum: "acebd689428898141d4216ff6db3d43d36955216a407e8687d5b993260f0eaed"
		)
	]
)