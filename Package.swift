...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.38.xcframework.zip",
			checksum: "aa54b35f7f82ab8fe95dff7ad363262299c814bd043400b5038f03e18fd7af81"
		)
	]
)