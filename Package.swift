...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-1.4.0-rc.1.xcframework.zip",
			checksum: "358c4d897b80ddf8dcc9a99c11fb3c0c6950a393f16e4306c78e8094093e2f5a"
		)
	]
)