...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.16.xcframework.zip",
			checksum: "dba5d1ecb1a5db0694a3b965f059f2f8d26a5dd4938be8aef16e769b4bf03f3d"
		)
	]
)