...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-1.3.5.xcframework.zip",
			checksum: "7fe6a7694fbec746dcf6f469e9a6ad74af82734013472512324124418af49a87"
		)
	]
)