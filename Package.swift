...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.3.0-beta.8.xcframework.zip",
			checksum: "3b20f967691a47df9c8fa4ab0fd05cc11956a8da56eb19d019e1c3dee3e55093"
		)
	]
)