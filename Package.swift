...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-1.4.30.xcframework.zip",
			checksum: "8a060a52431302450a210a2d6779808ce4984daaffb2698e5eeec1f7f94b7e22"
		)
	]
)