...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-3.2.0-rc.0.xcframework.zip",
			checksum: "20f7abf33c0cee370d9128511f3f504a2a249ab1211c7c01a3d7aa04a5c352f4"
		)
	]
)