...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.5.xcframework.zip",
			checksum: "6bab49655d80b2afe7457f249de6707c3b919d38b338551e874e244be630651e"
		)
	]
)