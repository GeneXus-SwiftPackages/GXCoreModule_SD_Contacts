...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.22.xcframework.zip",
			checksum: "ff9de43d0ee89b7848d0c26f093e1800aa0bc51f576cd7a4af025a2c4119b983"
		)
	]
)