...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.28.xcframework.zip",
			checksum: "20ec6f01904a86c5b1bbbf18c9df522ca814d62e309bfed8db06517fd778efaa"
		)
	]
)