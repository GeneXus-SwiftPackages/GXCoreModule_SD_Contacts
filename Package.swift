...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.15.xcframework.zip",
			checksum: "d6163729b2d7fb01ee62d9eeb4e5ee3233113800347222bc234d15950e2af66a"
		)
	]
)