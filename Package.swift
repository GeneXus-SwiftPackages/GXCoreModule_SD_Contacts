...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.11.xcframework.zip",
			checksum: "368a75bd8ca930a79747993057e72605d21b179a594719e86ffb24acc6876d10"
		)
	]
)