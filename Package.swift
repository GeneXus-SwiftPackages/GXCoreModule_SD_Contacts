...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-1.1.3.xcframework.zip",
			checksum: "18e002c274f84fcc6248a018f418db637c076d341ecb0a4049ce36263d6260d2"
		)
	]
)