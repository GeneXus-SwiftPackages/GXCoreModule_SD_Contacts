...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.24.xcframework.zip",
			checksum: "40e385103825a72a91951705232eafae7b7e8ccc0573c3206c8c06dc08aef037"
		)
	]
)