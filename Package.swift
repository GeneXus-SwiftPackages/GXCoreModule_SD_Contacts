...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.4.0-beta.3.xcframework.zip",
			checksum: "37a79ca3953bbbd61ee8dea9358940906ac0ac344afbb1cce7020313316f7dc4"
		)
	]
)