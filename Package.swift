...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.1.0-beta.26.xcframework.zip",
			checksum: "87fe2cb6f5281ee1047d9c5803613bcb56f83572008af5b6640aa0782a1e8298"
		)
	]
)