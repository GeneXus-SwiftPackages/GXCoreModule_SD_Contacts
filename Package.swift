...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.14.xcframework.zip",
			checksum: "3e938fe895703a5f52d63fb19d922044496f205c69ca015ad9b23e9b3238322b"
		)
	]
)