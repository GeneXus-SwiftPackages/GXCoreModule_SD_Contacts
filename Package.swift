...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-4.2.0-rc.20.xcframework.zip",
			checksum: "331139bf8cfbe22d4bd21316187798c6c0ff90ba7f20bc4ae74f70d5bd3945e9"
		)
	]
)