...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.29.xcframework.zip",
			checksum: "653473c46b2b0dd71f5921ec8a9113488f1cb643b3c2dfb76e99a628a47b84b3"
		)
	]
)