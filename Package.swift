...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.6.0-beta.0.xcframework.zip",
			checksum: "e8e290e1d555fab5219e65ab51790bc51123b47cae1b0219ebe0991aa2fe8589"
		)
	]
)