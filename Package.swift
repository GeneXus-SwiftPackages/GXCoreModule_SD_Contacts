...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-4.0.6.xcframework.zip",
			checksum: "4eed6d73fd566c0e30f78b223b200c8ded53afe0673de9108ca549309d9882e0"
		)
	]
)