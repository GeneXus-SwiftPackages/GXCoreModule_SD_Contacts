...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.2.0-beta.10.xcframework.zip",
			checksum: "d65746e7d428cdf20c14460d6e1c1e689df52b11a1bcc56ca501f4b82b1899aa"
		)
	]
)