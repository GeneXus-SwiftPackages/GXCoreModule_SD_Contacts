...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-3.0.3.xcframework.zip",
			checksum: "0ac9c1f3aac78d437538382005953f8968604c8e89b607b278e6e071bea6f4ce"
		)
	]
)