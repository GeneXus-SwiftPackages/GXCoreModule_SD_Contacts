...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.9.xcframework.zip",
			checksum: "2b0a247d10020c553e23962ca4f217d846cee286873e4b0f3299cbb3011795a3"
		)
	]
)