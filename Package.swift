...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.13.xcframework.zip",
			checksum: "ee29b5ca0c02021a385adde444cb6ce83bcbb9d0705665a2ddae2eecfc2c6567"
		)
	]
)