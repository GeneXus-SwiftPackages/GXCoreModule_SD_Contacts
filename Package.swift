...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.8.xcframework.zip",
			checksum: "36c0f62245f150f86e7d690041e13de4d4137feb35442d6baab8d2010fa04c28"
		)
	]
)