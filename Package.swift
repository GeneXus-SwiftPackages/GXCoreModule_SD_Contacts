...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.0.0-beta.10.xcframework.zip",
			checksum: "b78e3d60eef4fbd824217036d1b32e88fbb89f3b71724a5276245f75d21f0f01"
		)
	]
)