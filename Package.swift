...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.29.xcframework.zip",
			checksum: "bec54873fed0b9b59822fbb2022fa4c29e503112c043eded2a830f6f5e1a9441"
		)
	]
)