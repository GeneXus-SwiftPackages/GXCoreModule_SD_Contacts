...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.2.0-beta.24.xcframework.zip",
			checksum: "a2eea80675a14be61c0f925781c3e647244a6e7fa24145985af3eeacb30e0451"
		)
	]
)