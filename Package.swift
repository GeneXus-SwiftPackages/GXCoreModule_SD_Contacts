...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.25.xcframework.zip",
			checksum: "285c597e85999a002b73e90bc66473332ae56905ca249ae532b22c3c06c4bc29"
		)
	]
)