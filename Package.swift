...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.32.xcframework.zip",
			checksum: "1fe1c6da1b92257a61770d54ea8f9de19ec4c40188ec07de7478a20f67dac617"
		)
	]
)