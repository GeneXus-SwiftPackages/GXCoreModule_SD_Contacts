...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.1.0-beta.8.xcframework.zip",
			checksum: "16b74153b235eb7508f594ed0c4dbdb476790b5ab757ddc2ce76eda54ff1534c"
		)
	]
)