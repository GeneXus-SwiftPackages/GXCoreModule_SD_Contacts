...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.4.xcframework.zip",
			checksum: "2a8f9c0a47f90564c290050c921840f1724940a990c37893148c684fbc001769"
		)
	]
)