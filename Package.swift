...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-2.1.0-rc.23.xcframework.zip",
			checksum: "dd747f16dbaa04017a285641768fe3b58c88ece1619d066ed4c88761c4f5aee1"
		)
	]
)