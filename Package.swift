...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-1.3.0-rc.13.xcframework.zip",
			checksum: "f91185d8af8f494926e8904064f461221987422ff5c5b6e663bac10808272a6f"
		)
	]
)