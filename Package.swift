...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-2.2.0-rc.3.xcframework.zip",
			checksum: "0d40193799bfc4c46f914b4bcab373a1a8c668e172004fc1e05ce9f4d5846e79"
		)
	]
)