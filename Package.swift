...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.18.xcframework.zip",
			checksum: "8fc946d11a7d9d202af132a2d5645f16b0f2d62080bf35b1b8b273c2bc37dd6a"
		)
	]
)