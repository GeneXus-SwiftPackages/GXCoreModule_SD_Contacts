...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-4.2.0-rc.0.xcframework.zip",
			checksum: "ccf8978297248c5d8920d589ea83fb9b382e3b8c154689c4a7ad0b8974749957"
		)
	]
)