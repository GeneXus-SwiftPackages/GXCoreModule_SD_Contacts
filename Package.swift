...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.27.xcframework.zip",
			checksum: "1afcad15ecd625952a72076f685aea0c9922fe9d1bf05e4736dec93b123f82db"
		)
	]
)