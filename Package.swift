...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-1.5.0-rc.2.xcframework.zip",
			checksum: "1e0b0bd6df58de9bcab4b24285a579a7d23c99045817cfee423f0b9981202392"
		)
	]
)