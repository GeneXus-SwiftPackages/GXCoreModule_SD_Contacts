...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.4.0-beta.13.xcframework.zip",
			checksum: "725ed49c08e2dbd7c33098873dd5e902efef8f03696e2d9235a733a54fd976c0"
		)
	]
)