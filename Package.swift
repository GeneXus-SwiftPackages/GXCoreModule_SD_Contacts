...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.17.xcframework.zip",
			checksum: "ee3ee9d9400fb316a302fa593249f2e8a092098643ae1d99639c13b5e5901a3f"
		)
	]
)