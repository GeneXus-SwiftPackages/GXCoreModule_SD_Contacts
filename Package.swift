...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.31.xcframework.zip",
			checksum: "eec9e032ea1d76338823735d7b43ac02ed805574cbcfde51ef23bc0bb80b10c0"
		)
	]
)