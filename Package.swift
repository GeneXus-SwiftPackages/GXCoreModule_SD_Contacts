...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-5.0.0-beta.4.xcframework.zip",
			checksum: "e9162b8e531fd5042ca309ded1d31937d5c40c5783fbca7a8f537ebd997973a3"
		)
	]
)