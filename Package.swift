...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.6.0-beta.3.xcframework.zip",
			checksum: "51cd9a6abffc324f6ea61d27c57d7966847a90b0adb53d0e846a187b1cb39373"
		)
	]
)