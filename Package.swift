...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-1.2.1.xcframework.zip",
			checksum: "de9feeda6b79c39f292d9b08638addd00070f74305d3df5b8bd00fd5aed1f9f2"
		)
	]
)