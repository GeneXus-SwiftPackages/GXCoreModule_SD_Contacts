...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.3.0-beta.6.xcframework.zip",
			checksum: "0d244a471da8ceb277473b3f14b4bae31e6af8a4d4f2b93af8bc99470c2b00f5"
		)
	]
)