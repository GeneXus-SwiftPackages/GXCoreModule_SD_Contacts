...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.38.xcframework.zip",
			checksum: "bd139eedfa0b8d27f75e1ffc3e44cb16bed5ac291c8158a1c16edcd8e8f0baac"
		)
	]
)