...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.2.0-beta.12.xcframework.zip",
			checksum: "47504c1b57a11ed1ec7728c05924cb32f8835709d1744b510ece767bbba95d2e"
		)
	]
)