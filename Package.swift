...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.13.xcframework.zip",
			checksum: "df67656b6357d4b347bc66f09c8c2e6ecee81bf84511efaefc5b60a5701708a9"
		)
	]
)