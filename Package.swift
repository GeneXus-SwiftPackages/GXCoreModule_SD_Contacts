...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-1.5.12.xcframework.zip",
			checksum: "0069c6d26a655a107e562e2ac7e100215e5034feaafb975f206c8a086d00efea"
		)
	]
)