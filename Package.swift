...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.9.xcframework.zip",
			checksum: "4cfa6d5ded298237cb59cb76b7ca6b9f0d36ab56b1296fcac85902c36fe5b67b"
		)
	]
)