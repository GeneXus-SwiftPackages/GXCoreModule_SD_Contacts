...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.37.xcframework.zip",
			checksum: "ed768ff3901e71debb95940b630933fcbccd25699dfcd61cc66a803725fc8049"
		)
	]
)