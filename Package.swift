...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.25.xcframework.zip",
			checksum: "a55b27d2cb6e86a3c0aa6b0da3d18206758c541a3f1ea9b80e3a4f7e76b8de64"
		)
	]
)