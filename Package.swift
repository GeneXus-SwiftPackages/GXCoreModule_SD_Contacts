...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.19.xcframework.zip",
			checksum: "03af5e2cdff5b425be15fb5e9acb77f6393bd3278160cc54cab49b84ad76704c"
		)
	]
)