...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.2.0-beta.9.xcframework.zip",
			checksum: "8e42d982bf08aece00755b6322a25b6ddfaff5fe54175d6ecf7341bc8f7ca1bd"
		)
	]
)