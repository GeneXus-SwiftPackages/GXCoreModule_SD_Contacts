...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-1.4.0-rc.5.xcframework.zip",
			checksum: "f483e2abdca2e1da3df721da208488019f3434841e368c6ab23aeca225bcb369"
		)
	]
)