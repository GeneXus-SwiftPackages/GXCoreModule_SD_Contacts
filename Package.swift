...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.0.0-beta.48.xcframework.zip",
			checksum: "bc2c17aa424ed8d001ab3a1fc6f9afcb98950bd25a125010256079fe0f94149d"
		)
	]
)