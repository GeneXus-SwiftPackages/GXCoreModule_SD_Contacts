...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.6.0-beta.1.xcframework.zip",
			checksum: "e27d448e9cae8b7ee722c0b2946db8372f1aa7b7d222b71f3f4fe043fce2b8bc"
		)
	]
)