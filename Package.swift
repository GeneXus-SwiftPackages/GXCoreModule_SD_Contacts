...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-1.5.0-rc.28.xcframework.zip",
			checksum: "80d76b16e155bbfc3c9ebb9eebc98f02e12df36fac3f5a6bf087a338793b5d90"
		)
	]
)