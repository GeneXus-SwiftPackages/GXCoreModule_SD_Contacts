...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.19.xcframework.zip",
			checksum: "f333d5241babb88bdc14be7e790effad12b90b8ffe4158382bbfd39b7f31ab5a"
		)
	]
)