...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.3.0-beta.4.xcframework.zip",
			checksum: "e61e371fe3a522693ecc8d86b6f9432a56aac9c696edefe9f2b51d81a3d0ca51"
		)
	]
)