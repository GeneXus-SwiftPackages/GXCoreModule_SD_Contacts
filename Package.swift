...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.0.0-beta.12.xcframework.zip",
			checksum: "447cac0604107d579cee058869e9d68c674191cefc63ce62d8d6fdae7ad6b54e"
		)
	]
)