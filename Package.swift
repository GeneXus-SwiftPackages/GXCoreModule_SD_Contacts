...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-4.0.0-rc.0.xcframework.zip",
			checksum: "cec2ecbf32432f38cce2527ec8fd71da8278f6ad4eb0f13dbcd1de6c3125f0ec"
		)
	]
)