...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.1.0-beta.794.xcframework.zip",
			checksum: "2fd6e10aa44822ed13b20ba3477023851cfa01e1793c2a50c8c3b5c7e21d7d03"
		)
	]
)