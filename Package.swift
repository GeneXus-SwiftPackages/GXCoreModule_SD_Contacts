...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.9.xcframework.zip",
			checksum: "d13b33c96a6dfa8a793f2789f11aefdac4a210f597ba1ae6d3586bf8b2193a4c"
		)
	]
)