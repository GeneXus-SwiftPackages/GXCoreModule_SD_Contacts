...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.25.xcframework.zip",
			checksum: "e6cf6ef339ef701db7d0773acda6104c3b436d3f0eb1f27dfa90dbe44475e790"
		)
	]
)