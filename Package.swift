...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.2.0-beta.18.xcframework.zip",
			checksum: "ce3d715c011aed206ddad06a8f6dee0ac1b6c0f8258c3f71d5494fb2810e5896"
		)
	]
)