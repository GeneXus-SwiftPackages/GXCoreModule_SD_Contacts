...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-1.2.0-rc.15.xcframework.zip",
			checksum: "409e79abd6e92489eb7017cd432ed87a65d65e56b154546ea803c8072bd500af"
		)
	]
)