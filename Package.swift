...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.24.xcframework.zip",
			checksum: "feaa77de29a41cd108c21e72b1f0e20bdfa9ddce233ce63ad5226378d162ba89"
		)
	]
)