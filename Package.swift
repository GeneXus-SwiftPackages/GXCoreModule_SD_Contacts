...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.12.xcframework.zip",
			checksum: "288966e5bdde8f98ef97d2a12e8bb9ec3db547ee5ef3a6dbbd28658a0787a687"
		)
	]
)