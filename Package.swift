...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.18.xcframework.zip",
			checksum: "fba1e4cf2817a0dcc80ccdab984e2b04c1c349b7f2c680ed7162f27ca8d30b55"
		)
	]
)