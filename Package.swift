...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-3.0.4.xcframework.zip",
			checksum: "d41b39dbf51bfdf4d4b864b72b131bc0f3ec15b9445133abd6ec778258e924d5"
		)
	]
)