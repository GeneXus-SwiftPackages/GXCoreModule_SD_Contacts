...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-4.2.0-rc.3.xcframework.zip",
			checksum: "bf6b769ec4f8e227afdf2c9da1cbad3cb4b97b07f52a0ad08f4624a012333229"
		)
	]
)