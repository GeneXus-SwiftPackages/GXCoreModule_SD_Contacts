...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.25.xcframework.zip",
			checksum: "a36f05e17fffa035e7d6a2c29abb316071170cc4f2919bbb8d7531a9b5e0bc28"
		)
	]
)