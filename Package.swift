...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.37.xcframework.zip",
			checksum: "21c46b429256810c90fee6bb4cf1197ccb284f6f6c375b9eb349034045ce9d48"
		)
	]
)