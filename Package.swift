...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.17.xcframework.zip",
			checksum: "77b1c7b6ac66361d1bcf98ea0cee21984e661efd21dd5fa44c8db330eeeff001"
		)
	]
)