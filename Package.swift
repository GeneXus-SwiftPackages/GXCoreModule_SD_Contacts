...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.14.xcframework.zip",
			checksum: "76549b31f9871f514bd8e4297e5daaf8e1bcea87ebdcf26327e18a3972ec116a"
		)
	]
)