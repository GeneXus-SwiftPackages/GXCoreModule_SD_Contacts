...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-4.2.0.xcframework.zip",
			checksum: "581978245ce2f6e7725fec6863332ac8ef388e67d7707f8f64094549d631f0f3"
		)
	]
)