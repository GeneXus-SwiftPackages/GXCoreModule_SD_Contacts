...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.27.xcframework.zip",
			checksum: "8c635c592afb3f7ad3d0eb1bca445bba2772b6bdc98160e9efe0b1bcb7434a1c"
		)
	]
)