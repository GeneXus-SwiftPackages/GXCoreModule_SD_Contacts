...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.0.0-beta.20230615110131.xcframework.zip",
			checksum: "96dc651f4d3c77364de3ba17854fa0047746b5af383b3471269b1a7b332a9e98"
		)
	]
)