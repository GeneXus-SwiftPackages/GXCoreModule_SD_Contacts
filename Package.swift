...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.40.xcframework.zip",
			checksum: "9598b03d0d41221b32efeed27bafa1022cbcf2d1ef83ec679cb406e89a50ada8"
		)
	]
)