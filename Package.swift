...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-1.1.2.xcframework.zip",
			checksum: "e8e3e3ed28f085b4110483b83dbf99d5f274a195e3b7388798b1714512d8c8e2"
		)
	]
)