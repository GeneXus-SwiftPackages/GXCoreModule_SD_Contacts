...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.21.xcframework.zip",
			checksum: "2f7ffe39c69c1f0158f74cae7d47a210a0dc17614bf735ec3845e1db264f22c8"
		)
	]
)