...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.1.xcframework.zip",
			checksum: "891909c918d4a2153fddf50c6fd46f2f854ef16f8f92dd01be19f8f03d08e2c2"
		)
	]
)