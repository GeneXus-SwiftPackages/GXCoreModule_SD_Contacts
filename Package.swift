...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.6.xcframework.zip",
			checksum: "3d04deb14b579b23ce6e13f2c4e1b90e8494242f32e1fac09e0e97c8665bcb8a"
		)
	]
)