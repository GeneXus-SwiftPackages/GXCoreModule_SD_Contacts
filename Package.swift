...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-1.2.2.xcframework.zip",
			checksum: "5b56ad0b8dab1e4d4ebafee3d48708e7b4730eb21387b8c341ac6ba04fcfb44d"
		)
	]
)