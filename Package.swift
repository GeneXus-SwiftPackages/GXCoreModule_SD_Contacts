...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.5.xcframework.zip",
			checksum: "ab61e346f8a9e8df7d2dacb8b1383c0d9350db2e97f0eacbfead9cd9509ab03d"
		)
	]
)