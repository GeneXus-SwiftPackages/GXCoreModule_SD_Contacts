...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-4.1.0-rc.25.xcframework.zip",
			checksum: "3fb821b27fbc02d4c966842087f9d44cc527621a37e733c0a8da938959e41d1b"
		)
	]
)