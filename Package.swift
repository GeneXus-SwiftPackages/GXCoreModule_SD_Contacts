...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.3.xcframework.zip",
			checksum: "c674bfe58d7e6339d4310dd1274b3b31c116957d22684b60791d0808338fdc2b"
		)
	]
)