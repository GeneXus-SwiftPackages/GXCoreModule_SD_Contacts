...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.25.xcframework.zip",
			checksum: "38bfe51ca5c710664052e312248326cde030f405d3580d57ac24f551cae6b0f5"
		)
	]
)