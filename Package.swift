...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.26.xcframework.zip",
			checksum: "64d73c91182144197ac0d1bf3fc20e0bb0a67a33c3c7b62518e3e9717b9f9001"
		)
	]
)