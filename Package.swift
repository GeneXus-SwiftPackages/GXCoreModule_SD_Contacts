...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.0.0-beta.0.xcframework.zip",
			checksum: "1013556b4704de1fdb2639b1e703f43f9d6739b3901a99c5c383681f38492757"
		)
	]
)