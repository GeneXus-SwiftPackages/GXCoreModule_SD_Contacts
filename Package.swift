...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-3.1.5.xcframework.zip",
			checksum: "57f9e28e672edc8189caccef3b03690034ed3fbab906ada71ee827940eb5358e"
		)
	]
)