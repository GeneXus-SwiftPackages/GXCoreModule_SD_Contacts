...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.16.xcframework.zip",
			checksum: "121fd4bc51fdad70aacf0512ea76e29955603fb72cb5fbba5cad08e2f5eeb988"
		)
	]
)