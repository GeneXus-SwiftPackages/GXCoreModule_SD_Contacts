...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-4.1.1.xcframework.zip",
			checksum: "f950d7d6b96c85fa16a636fa473d919c80af36cbaa464955b6a547d2f431daa1"
		)
	]
)