...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.1.0-beta.9.xcframework.zip",
			checksum: "5358a542aaed97769da7397c9cabeb0d4807ef3f04face36dc7be6aac4b4cb43"
		)
	]
)