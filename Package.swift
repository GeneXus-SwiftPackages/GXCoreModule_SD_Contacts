...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.12.xcframework.zip",
			checksum: "d0e16a664ae90cd551f6045bbe0017cb644ae0606d1598cf0af75fcc31e508b0"
		)
	]
)