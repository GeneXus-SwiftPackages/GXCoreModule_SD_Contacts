...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.2.0-beta.21.xcframework.zip",
			checksum: "582457c90173a5a2c6cea2ec856ba3819de586d28c17e11f115d01e3a00d95d6"
		)
	]
)