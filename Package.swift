...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.8.xcframework.zip",
			checksum: "9169b37ba88cb17708a1b8c2f3cba509c2775bb8f2f7c6b160d318526f9cbfdd"
		)
	]
)