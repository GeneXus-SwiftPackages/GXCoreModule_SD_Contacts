...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.0.0-beta.13.xcframework.zip",
			checksum: "027c6c62037e6a45f12b25289e8dea602b7be28cd013f77f805fab072849da80"
		)
	]
)