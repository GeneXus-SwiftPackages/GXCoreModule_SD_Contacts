...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.10.xcframework.zip",
			checksum: "0b337713632bdffd4281c5a9fa0123cd949f80e9c20a58de0b88f9fd7b0db135"
		)
	]
)