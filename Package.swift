...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.20.xcframework.zip",
			checksum: "87ea87e14f080c2685042a88275c9dbdea04f6d34c5d45a034588a1d9d250805"
		)
	]
)