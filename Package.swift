...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.15.xcframework.zip",
			checksum: "d04781d07b936b1dc3565e88fef1253a5b187117abb58e9cc25c7d4de6076b92"
		)
	]
)