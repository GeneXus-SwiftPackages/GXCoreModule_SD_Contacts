...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.2.0-beta.20.xcframework.zip",
			checksum: "5d17f57f8965d5ce2ba3b094206c16d1b37acfa1f5db94c960635240b821a697"
		)
	]
)