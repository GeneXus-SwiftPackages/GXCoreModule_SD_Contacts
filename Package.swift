...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.24.xcframework.zip",
			checksum: "a7d5d7e845868b741263a146dd5640591476a1c45481880b3c6dd72c0c2a43a4"
		)
	]
)