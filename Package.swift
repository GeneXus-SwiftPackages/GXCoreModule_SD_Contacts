...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.1.0-beta.795.xcframework.zip",
			checksum: "a42ce4cc111e7c0667280b1266da6a91df75b1ee8003a03f5230cb836316fb61"
		)
	]
)