...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-3.2.0-rc.9.xcframework.zip",
			checksum: "c55e345c439cd365e5e0f0d474cce924e27ace1acc015110e04aa8e16b418b25"
		)
	]
)