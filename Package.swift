...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.31.xcframework.zip",
			checksum: "be4cbf19b42cf10ad455430fa12828c2357d470db9371ae779940cfb74348712"
		)
	]
)