...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.0.0-beta.16.xcframework.zip",
			checksum: "259e2b96356aca6df1251d55df6256da404d08389999c61255f63014a2386ca4"
		)
	]
)