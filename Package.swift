...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.1.0-beta.5.xcframework.zip",
			checksum: "750b3edefc2dc220f7e328c3bca0139ba50fcd9c7372d4b8ff7bd3d86da4fb97"
		)
	]
)