...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.35.xcframework.zip",
			checksum: "63f12e3a9c6de691bb64a6d3b11153085c80215c8fc535fd967879ea5b71f5b9"
		)
	]
)