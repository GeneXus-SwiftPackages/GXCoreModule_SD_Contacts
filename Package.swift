...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.8.xcframework.zip",
			checksum: "aff3e3a6b820e29f551b9409d0db3df7b5ded2224891c037e3f2674f17af1f63"
		)
	]
)