...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.33.xcframework.zip",
			checksum: "33cfb878a4858e6bda55b7e4aeed03796dfab187ad51b4c43f326a3ecfc7609c"
		)
	]
)