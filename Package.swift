...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.10.xcframework.zip",
			checksum: "dc63ffcb5fa149ae095a0cca800cb9fd6b551296c5d6af6248f7ca9a82c0bf39"
		)
	]
)