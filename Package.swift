...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.19.xcframework.zip",
			checksum: "763a576af46814848eef6e713ee4c5622437a030fd7ed4ecfe24550aec47ad39"
		)
	]
)