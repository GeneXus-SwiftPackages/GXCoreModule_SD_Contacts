...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.4.0-beta.5.xcframework.zip",
			checksum: "eacb9e098713c2206642f694e51945f91166ca169b89f9e345fc058df5bca18a"
		)
	]
)