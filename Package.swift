...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-3.0.0-rc.15.xcframework.zip",
			checksum: "33abdca406e948eab606e172ea87aa35c1250d300ef1c93c2139f27647cbeeda"
		)
	]
)