...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.33.xcframework.zip",
			checksum: "2c25ba876a4672e1747afa905d8a9998dbb78b59b9499af7c691e8efeddc5dee"
		)
	]
)