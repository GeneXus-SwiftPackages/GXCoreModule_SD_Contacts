...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.2.xcframework.zip",
			checksum: "afdc321eb612bf3d94e8d38026c025588bc266d49d2f71caad35c79bb9fe1831"
		)
	]
)