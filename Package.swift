...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.9.xcframework.zip",
			checksum: "509a36d1be7c56bd6015b3d1cc2ca12f3ef705d87844c4c0aa5d84fbe2a75823"
		)
	]
)