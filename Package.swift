...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.23.xcframework.zip",
			checksum: "5c0b16903c1d5c14aa885f2c62bcfbe13c675384a14e391c2648a638a83cc53d"
		)
	]
)