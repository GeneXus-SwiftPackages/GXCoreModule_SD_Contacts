...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.2.0-beta.14.xcframework.zip",
			checksum: "927e277096e9dafce6ac612d90be9094e860938cd787f5b7b2733414d040bc54"
		)
	]
)