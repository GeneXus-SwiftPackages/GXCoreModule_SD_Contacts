...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.24.xcframework.zip",
			checksum: "1ea14f1e2c325ab79be8f751de1d2c2a622c560b919e1fddaf2b60978e57299d"
		)
	]
)