...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-4.0.17.xcframework.zip",
			checksum: "5c444e51b84d760fb4dc0ce98508c59a50a9f6f4a3e37e9c5099a770656b1942"
		)
	]
)