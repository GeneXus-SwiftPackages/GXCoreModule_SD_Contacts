...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-3.2.0.xcframework.zip",
			checksum: "4574ae10c720badabe42d000abdfb9da1f23695552ba840cf78b8450173e5f38"
		)
	]
)