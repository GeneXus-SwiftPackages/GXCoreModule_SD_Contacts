...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.0.0-beta.11.xcframework.zip",
			checksum: "6665c3a526a6114ce1a149d54fdf833c6775c0a2dcd149c512a5a07a317e4c28"
		)
	]
)