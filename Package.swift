...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.20.xcframework.zip",
			checksum: "0b684193ca44eb79c8a16ad99d1e420ee9abf1089cf06aea9a622484fe9f4298"
		)
	]
)