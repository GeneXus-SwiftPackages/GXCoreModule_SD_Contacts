...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.2.0-beta.26.xcframework.zip",
			checksum: "2cfa613fbe9043b2dfcc65c2a0b0a48327dc1655cd044e684bfd48c745153ca5"
		)
	]
)