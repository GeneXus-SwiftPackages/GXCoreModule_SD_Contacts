...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.5.xcframework.zip",
			checksum: "056f672b74087674453af2f80ecdbd91b7773f3752b5ef04e25b972b3f8e5504"
		)
	]
)