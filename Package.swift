...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.3.0-beta.5.xcframework.zip",
			checksum: "ef250a1489b63d361782ff58305ac441cc875b3e4f9faf1ee6d7c3312b90f409"
		)
	]
)