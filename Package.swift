...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.4.0-beta.4.xcframework.zip",
			checksum: "9600d0c4d3d5b63f61a438921667bc5722ff1323519a71fd2d185bcd97836fb8"
		)
	]
)