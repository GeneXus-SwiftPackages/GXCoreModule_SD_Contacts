...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.0.0-beta.14.xcframework.zip",
			checksum: "68054ffde72f0cb555996ceba06883a45c30563dc6bfed8980eb1f20edb04ec2"
		)
	]
)