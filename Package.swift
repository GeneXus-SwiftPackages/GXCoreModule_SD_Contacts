...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.23.xcframework.zip",
			checksum: "5edc199d3e6d040a1bf974d16c4f7faf569442d408f95d4b918acd4e2e835b47"
		)
	]
)