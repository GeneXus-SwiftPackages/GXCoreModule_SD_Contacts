...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.23.xcframework.zip",
			checksum: "5eeaab69983fa28c80e22c71c3469be3adbc0cad6a229cdee64e8b23b489b163"
		)
	]
)