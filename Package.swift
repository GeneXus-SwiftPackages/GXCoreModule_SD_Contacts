...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.18.xcframework.zip",
			checksum: "e05b6678c21fec863b9f79159a02b4731eb8f2c7595a2ba4852ba93d24d3c6a2"
		)
	]
)