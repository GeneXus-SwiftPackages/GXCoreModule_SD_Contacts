...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-3.0.0-rc.8.xcframework.zip",
			checksum: "4dbb203e52fcf3abd8b05e76a9d231896104e5357d5d4087152e589e26e61062"
		)
	]
)