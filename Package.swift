...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.16.xcframework.zip",
			checksum: "d67ad9d5368d0315a0aafa802a5b23600186469de1367f9c2af5eb591b99ab84"
		)
	]
)