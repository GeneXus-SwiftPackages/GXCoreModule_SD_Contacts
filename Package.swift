...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.0.0-beta.49.xcframework.zip",
			checksum: "2baf1eff5e323bb62443be3ea61e801442af8ce071e5186a1d7003568eec01f6"
		)
	]
)