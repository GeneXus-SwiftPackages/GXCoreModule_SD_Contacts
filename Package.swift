...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-4.1.0-rc.22.xcframework.zip",
			checksum: "3feddb53e1a0b415e6538cb3d82a9b0a620b48e1497a49702eac245d84fc861c"
		)
	]
)