...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.20.xcframework.zip",
			checksum: "6fbdfdcf0e353d0ba5f47110142a7998616c7453a838c868438c3df581681ce4"
		)
	]
)