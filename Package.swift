...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.27.xcframework.zip",
			checksum: "eaccaa7c131b54e9746cb0229071a471a7b6ca1ec9de35186a28b78e1c403b7c"
		)
	]
)