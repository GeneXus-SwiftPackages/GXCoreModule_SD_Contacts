...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.30.xcframework.zip",
			checksum: "d71f9d8985c4a75738a92194c861b096d4200fc2419dca3f92b3d4e2f0842e97"
		)
	]
)