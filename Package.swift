...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.7.xcframework.zip",
			checksum: "98291facddec70935678c83b6c34a8f532afc0ea7dd2fa6583ba14b5a31b675f"
		)
	]
)