...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.19.xcframework.zip",
			checksum: "05597d49e9f9deda0a98a7e69bdd056d63272b098d3379308543d45534f32ee2"
		)
	]
)