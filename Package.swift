...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.3.0-beta.11.xcframework.zip",
			checksum: "bf7be84f9e80c0bcbfcc95e2cd1b273bd5be8e9f2ad915bf8b7f77740087b08a"
		)
	]
)