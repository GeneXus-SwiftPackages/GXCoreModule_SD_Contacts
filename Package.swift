...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.7.xcframework.zip",
			checksum: "758af0bf2700f8e1edaa26b57264b4d2f7dc22f49851c69e45bfd2d9572fa643"
		)
	]
)