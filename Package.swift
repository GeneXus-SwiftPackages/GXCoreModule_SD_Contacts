...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.39.xcframework.zip",
			checksum: "8ba4e1f2d79e0409057d4c2bf7d1b0d119c14925318c1ab4fcc1a28ecc147c6c"
		)
	]
)