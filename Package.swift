...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-2.0.17.xcframework.zip",
			checksum: "b48a1f5f79d7588b3e3d32a025839c8e0e112540d5576ed2b70d3f065aaf7734"
		)
	]
)