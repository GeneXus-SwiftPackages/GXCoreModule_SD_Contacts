...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.3.0-beta.3.xcframework.zip",
			checksum: "b272d5e104d38d2aba8da9ff358adedd66e184f5511ec975434ae508f9adc21d"
		)
	]
)