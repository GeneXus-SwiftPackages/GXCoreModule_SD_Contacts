...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.17.xcframework.zip",
			checksum: "2f7f9da854bb60de51eccaa47b9b5eafbd997d082db5cd52047b598857b498da"
		)
	]
)