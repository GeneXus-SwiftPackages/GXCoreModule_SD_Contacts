...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.27.xcframework.zip",
			checksum: "531b6b50705faea71839fa4b440902d621d31517e0e4f0168f7c85acea4bc7b3"
		)
	]
)