...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.2.xcframework.zip",
			checksum: "759c107271988151cbb4f09ad96762f882560fd8106d1e1b5aab7eee8199358c"
		)
	]
)