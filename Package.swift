...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.7.xcframework.zip",
			checksum: "7139c8a97d6183610ed722c63e1e797dacc45a29a5be26b256144d0e61395b3d"
		)
	]
)