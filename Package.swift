...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-4.2.0-rc.34.xcframework.zip",
			checksum: "8d8fd57d52662bf190d3cfad4377d73ee5f4fee3dfc73e002292c4b38797fb5e"
		)
	]
)