...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-1.5.0-rc.26.xcframework.zip",
			checksum: "fdedf588b4342ee09001ba1a6c9ba9156ccac9627c5fe3c34982d8995a28bbe6"
		)
	]
)