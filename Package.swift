...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.3.xcframework.zip",
			checksum: "0a0f4279f6e76d5a987fcd2a1da7b1f79b7ec3614c2c44ec72a691b4043040d3"
		)
	]
)