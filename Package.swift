...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.2.0-beta.8.xcframework.zip",
			checksum: "7eb0d4312c075bfb60ca9bfae244ffb3b84b48c46456c58cbd9535a7af4b2caa"
		)
	]
)