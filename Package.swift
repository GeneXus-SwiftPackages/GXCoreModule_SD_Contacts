...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.20.xcframework.zip",
			checksum: "4aedf6faec3f63db50de25b9f445de9a0f27b9ecf01f4f2b4489c5154dd7c953"
		)
	]
)