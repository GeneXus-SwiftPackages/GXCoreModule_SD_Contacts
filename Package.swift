...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.1.xcframework.zip",
			checksum: "5a770f02a0d24eb702c2e78c6911c79479ab9e831bcda4b62dd7a5141a538bdc"
		)
	]
)