...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.28.xcframework.zip",
			checksum: "14d0162ae0e94cf6bc9477234995e4b1654fbe1fecc85a72a1211c0f5d739bc0"
		)
	]
)