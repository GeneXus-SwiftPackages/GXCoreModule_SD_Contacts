...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-4.1.0-rc.14.xcframework.zip",
			checksum: "3ce4c57137cde0c0b435a3dba0bd285d1b05ba168fe48526995fab38a23e99e0"
		)
	]
)