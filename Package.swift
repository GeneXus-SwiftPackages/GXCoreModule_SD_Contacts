...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.4.0-beta.19.xcframework.zip",
			checksum: "f727afba77ec55778402b66916c12f4fc87eeba8d58d41cc04de79f0f7404162"
		)
	]
)