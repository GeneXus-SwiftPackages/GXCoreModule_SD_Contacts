...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.36.xcframework.zip",
			checksum: "6dac1d185b080d12af5afa83307f7f16fb4fcd320e2c8bb8de180a4664e0b184"
		)
	]
)