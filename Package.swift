...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-4.0.5.xcframework.zip",
			checksum: "a2d6260b93ae54cda0ae2e13693033671c25e462eb4a99e636c3d95e3e7c407d"
		)
	]
)