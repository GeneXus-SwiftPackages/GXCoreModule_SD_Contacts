...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-1.1.0-rc.4.xcframework.zip",
			checksum: "f2b08d6d969a01bc16e300d583c2946c9e5dfc53956037384e5e8a0d28eeaa28"
		)
	]
)