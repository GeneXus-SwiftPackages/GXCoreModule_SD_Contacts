...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-1.2.0-rc.25.xcframework.zip",
			checksum: "748f067abb9f38e9fa77a2e329d0f6db361113a6b7ac458617616995a9d27f3f"
		)
	]
)