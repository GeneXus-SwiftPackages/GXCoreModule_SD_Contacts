...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-4.1.0-rc.3.xcframework.zip",
			checksum: "7712872dd0cde8dab99e6e2484aaa5b20f3c96b4ca641066872137067b9e9e8b"
		)
	]
)