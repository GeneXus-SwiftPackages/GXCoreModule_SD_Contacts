...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.5.xcframework.zip",
			checksum: "c43978d25744a10e5218fa29491d215b45f3c9941cae945dc078c00f472ef832"
		)
	]
)