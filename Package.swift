...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-1.5.11.xcframework.zip",
			checksum: "ddddc1d31c175a56c89dcca7deca5f12b0b253e91f53148034c5847e1ee8049d"
		)
	]
)