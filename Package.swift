...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.37.xcframework.zip",
			checksum: "ff6533920682037308541414468448c6c3fc793bbd23f0e4e056992bfedaf439"
		)
	]
)