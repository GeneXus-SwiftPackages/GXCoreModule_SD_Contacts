...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-1.2.0-rc.29.xcframework.zip",
			checksum: "080476a7d01ebaec946a3002e5f647051fc8e62230e5fd38277bf5159c3f2304"
		)
	]
)