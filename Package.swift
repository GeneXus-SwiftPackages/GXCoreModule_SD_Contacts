...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-1.3.6.xcframework.zip",
			checksum: "4d767523f414af17889624abbd729db0ca184e9e6c610f47e35e45225354dd79"
		)
	]
)