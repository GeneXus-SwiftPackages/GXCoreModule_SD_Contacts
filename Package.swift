...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.21.xcframework.zip",
			checksum: "2e3d6dcee25a15d272bbb74eb5068b350b660aed657567f5fc95cc891786729e"
		)
	]
)