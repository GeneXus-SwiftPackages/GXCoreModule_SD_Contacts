...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.0.0-beta.15.xcframework.zip",
			checksum: "f7cdaa1f2612a82723978e593f2ec06e9dca39b982e81e37d626c53e25275109"
		)
	]
)