...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.5.0-beta.21.xcframework.zip",
			checksum: "ce4e0c226491e5184c6cbaaefcc3b031c3c18a39dd69d51ab1fd152f2a39b194"
		)
	]
)