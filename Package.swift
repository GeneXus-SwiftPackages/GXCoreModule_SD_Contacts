...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.4.0-beta.17.xcframework.zip",
			checksum: "395184797993d1ef850b8359a97216b6d85ad5732921b587d7512cf31b7c7d02"
		)
	]
)