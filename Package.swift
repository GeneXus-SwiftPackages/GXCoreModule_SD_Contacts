...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-5.0.0-rc.0.xcframework.zip",
			checksum: "37e99320455407f68a252a68279965dd9145d5c71b76ca1c85bafadfdf88fd36"
		)
	]
)