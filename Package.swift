...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.6.0-beta.2.xcframework.zip",
			checksum: "47dd42e6e399bd9e74d5667a8a9e684ebfaed7075b27bb6c027ded912de081ea"
		)
	]
)