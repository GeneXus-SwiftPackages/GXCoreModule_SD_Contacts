...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-2.0.0-rc.34.xcframework.zip",
			checksum: "3ef5c4142f92c6493c29afd1389d6f5edde7242097fa5cefc884b160ada6d6e2"
		)
	]
)