...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.3.0-beta.2.xcframework.zip",
			checksum: "6ccb878da4286f3b65662e9df75fc1173d65eeba51fc34f1ca79f9c8f6550642"
		)
	]
)