...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.41.xcframework.zip",
			checksum: "00b3790697c88dd683398310bfb294af8005a232a15cec51cab6f5191ca3551f"
		)
	]
)