...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-1.4.31.xcframework.zip",
			checksum: "68f684c28c1c1b3a88d3ad8e5741fde991fe1b1fd8a4a9517fca43485cf4e024"
		)
	]
)