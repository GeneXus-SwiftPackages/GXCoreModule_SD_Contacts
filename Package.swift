...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.4.0-beta.8.xcframework.zip",
			checksum: "6fc35046b04f05298a86ea91c707fcfc4d83301bbefabcd6aafcd4dfed1ef91b"
		)
	]
)