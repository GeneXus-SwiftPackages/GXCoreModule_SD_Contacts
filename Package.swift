...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.15.xcframework.zip",
			checksum: "73b06b4e56cbdca26777c749e78e1a2236cf70f47423b7f1619c0554040bc777"
		)
	]
)