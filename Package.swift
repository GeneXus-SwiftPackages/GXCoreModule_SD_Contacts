...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.30.xcframework.zip",
			checksum: "7cfa798dd8047584300fba072d6a436e5eada9b4b46c21661cf583e679ac77d6"
		)
	]
)