...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.1.0-beta.23.xcframework.zip",
			checksum: "1c6e52abadee93b7a0f51cbf3023619f3bbfdb1c1d0179f48b9ceac56afce076"
		)
	]
)