...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-3.0.7.xcframework.zip",
			checksum: "6ed7e2d9480a29533a0d2ab0c3ab7fb311b9504a9f0f44716e98661f789421d5"
		)
	]
)