...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.22.xcframework.zip",
			checksum: "20f152dce6c03bc8d3208d8a7ae12d16bbae8d287a4f2e0ea3c3821d1c1d79c7"
		)
	]
)