...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.21.xcframework.zip",
			checksum: "dc27ce7cd5ae3820c68445da4e7f802102f93aabc47db3a8110d7644004edafd"
		)
	]
)