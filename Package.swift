...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.2.0-beta.25.xcframework.zip",
			checksum: "f784131308cbbfaeb18941561948bcd05b24ec3cebbcbb7de1e0773fb46fdf61"
		)
	]
)