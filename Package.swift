...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.18.xcframework.zip",
			checksum: "ece298e413eba3ba694a922144771826f5aa745b8f61e5cef6c5a27d0b165edb"
		)
	]
)