...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.13.xcframework.zip",
			checksum: "85d676ae8d2845381b08d14c09b3f97dc2541e1a0fc14c06b39ec1977f323fff"
		)
	]
)