...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.14.xcframework.zip",
			checksum: "90e428fcb359059ebe9748defa5767c2f81b14c4a61e4d0d11754c80128caddb"
		)
	]
)