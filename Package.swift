...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-4.1.5.xcframework.zip",
			checksum: "70aa80f64bd1c87e32b1eb13cbe2f88fd7a01eac2a610ddfaab688c0b669185b"
		)
	]
)