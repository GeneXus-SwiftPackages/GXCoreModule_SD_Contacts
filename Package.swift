...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.4.0-beta.7.xcframework.zip",
			checksum: "d7f258f0a9e7c77774dfdcc74e22b861f6e7ba5927137fd3f5a46e41ebb0dbaf"
		)
	]
)