...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.1.0-beta.10.xcframework.zip",
			checksum: "adeb2327d83b2af36991a190cd35188bcf17741b9437296e3a07d7554daa9083"
		)
	]
)