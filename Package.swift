...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.1.0-beta.7.xcframework.zip",
			checksum: "34b94335b9f90d7c4554bf08ee5fedfbacd918cec144feac350f3c88ae60576e"
		)
	]
)