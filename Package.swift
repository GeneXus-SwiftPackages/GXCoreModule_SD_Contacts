...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.3.xcframework.zip",
			checksum: "c3a9f9d1281d5072579304ab9ebfeacb2bb2eb0ae3b634fdf7dacdc53ba532e9"
		)
	]
)