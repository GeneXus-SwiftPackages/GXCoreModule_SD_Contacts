...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.33.xcframework.zip",
			checksum: "3325ba8e548e5ba1116c6a9dac0711e4588e83e974736c7a1a9441ae9e745e79"
		)
	]
)