...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.4.0-beta.20.xcframework.zip",
			checksum: "33898ec9f27f2b874a6d682f493b9d6e1e54870ad789888886878c5cb0eb0417"
		)
	]
)