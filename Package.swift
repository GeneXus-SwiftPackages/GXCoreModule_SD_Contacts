...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.3.0-beta.1.xcframework.zip",
			checksum: "a1577a7d23d8325a7b82f4412a5d5495784079d6d5351193985c74eb78ecec69"
		)
	]
)