...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.27.xcframework.zip",
			checksum: "eba412b89c1a1a59cd22095936c3c2d5fbea47fbe1a51c477f19a51de7b8a769"
		)
	]
)