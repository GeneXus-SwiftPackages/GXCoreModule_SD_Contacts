...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.4.0-beta.12.xcframework.zip",
			checksum: "4dbe9f92096ebdcb1e95ad4af74ffa911231ef1662b5dc71362078a633a82b7c"
		)
	]
)