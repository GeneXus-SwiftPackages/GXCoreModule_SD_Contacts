...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-4.0.0-rc.43.xcframework.zip",
			checksum: "408972b992757bb3ea32934ad73943725425c5fbe938432ec6def4ed4aade64d"
		)
	]
)