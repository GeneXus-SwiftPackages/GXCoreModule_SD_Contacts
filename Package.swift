...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.22.xcframework.zip",
			checksum: "cb69cef051f8b874eff7a30d8f8eb30ded94e9237a69516fbf82e9743909e77c"
		)
	]
)