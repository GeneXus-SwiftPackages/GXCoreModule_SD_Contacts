...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.0.0-beta.45.xcframework.zip",
			checksum: "e24c365a0c0233fd9267e7ff514cd10fa978b946833298ebbb3f9fedfab01b4e"
		)
	]
)