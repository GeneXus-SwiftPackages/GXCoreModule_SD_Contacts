...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-1.3.0-rc.7.xcframework.zip",
			checksum: "12b28aead0d27f98317d2c3835554f9dac18c2cb2bed5d0dbba5093708b328f0"
		)
	]
)