...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.15.xcframework.zip",
			checksum: "4d9e5d96d5ca2e957166365a7ebaffea5c79d3f3934a1de6fb20b1a1a501d0bf"
		)
	]
)