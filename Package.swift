...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.9.xcframework.zip",
			checksum: "9358634ec1a3796043d75f4cb4443d1a79618a74e937ffd478087cb9afcea56a"
		)
	]
)