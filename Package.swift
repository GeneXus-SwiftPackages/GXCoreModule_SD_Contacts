...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.40.xcframework.zip",
			checksum: "78f10ce788aacda7731b688fbad086bb35c1472cf6d7d629fc8f3eebd6b0ab24"
		)
	]
)