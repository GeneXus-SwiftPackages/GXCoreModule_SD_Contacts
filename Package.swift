...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.1.0-beta.0.xcframework.zip",
			checksum: "2635b35461ffbd643e4234d9ef96cbc4e92bc1cc879cfc0bf94369f68e6b2a2f"
		)
	]
)