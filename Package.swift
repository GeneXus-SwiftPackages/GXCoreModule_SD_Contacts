...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.11.xcframework.zip",
			checksum: "4bc0f8c4ad74c538832f89eab0ef7d3f1161a34e3ffb9fbd164e4ea114816106"
		)
	]
)