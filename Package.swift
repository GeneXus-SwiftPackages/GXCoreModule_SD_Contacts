...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-2.1.0.xcframework.zip",
			checksum: "d851225660e608b264cbe032319fe2f673424c8a56316b90294dbe2cea4ad8a5"
		)
	]
)