...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.1.0-beta.6.xcframework.zip",
			checksum: "a74f7dbd84e88c2f29f5c8a2e4af981e5439eeb0bddf92a2698abb6ace03cdca"
		)
	]
)