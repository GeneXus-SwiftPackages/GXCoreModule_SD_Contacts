...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.12.xcframework.zip",
			checksum: "fc6ac115f207262022dea8b0769e0e7aa31e48a05b82b3e1c03323005e7f95e9"
		)
	]
)