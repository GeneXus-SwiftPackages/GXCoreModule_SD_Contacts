...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.19.xcframework.zip",
			checksum: "c51a8b49c368cae2b2381928b2a01e2c91e7bb8604543ac6df3a604cb8d0cc26"
		)
	]
)