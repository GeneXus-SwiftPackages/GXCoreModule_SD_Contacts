...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-3.1.0-rc.8.xcframework.zip",
			checksum: "89dfa0de70d137eef6c1a3ba00cdb26597da1646fb4433de6e1de789adac3919"
		)
	]
)