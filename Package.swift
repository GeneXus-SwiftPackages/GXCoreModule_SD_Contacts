...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.4.0-beta.6.xcframework.zip",
			checksum: "afac88b7f0dafcac1926660d65ad0a5bd2d724fa7679b2bb5ad8535c6658df92"
		)
	]
)