...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-3.2.0-beta.36.xcframework.zip",
			checksum: "fc35c866e6a5555944526518be83204ee9ac8d383b3d73f524a49cca37634918"
		)
	]
)