...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.3.0-beta.9.xcframework.zip",
			checksum: "a2f3bce15496e865b1ccaeebf12b7fadf0a297a3125e72bc108708904d0a3433"
		)
	]
)