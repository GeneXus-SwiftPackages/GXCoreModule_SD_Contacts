...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Contacts-1.2.0-rc.36.xcframework.zip",
			checksum: "4cb7d73697106e455172664bbddfb780e8af800318575fd9aa9c8d2a9a61d9df"
		)
	]
)