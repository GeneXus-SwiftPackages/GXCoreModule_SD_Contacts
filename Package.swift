...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-5.0.0-beta.1.xcframework.zip",
			checksum: "336b8d751505999f37d28a836c555c2794d8c486823e5b55248bae65a26bc08a"
		)
	]
)