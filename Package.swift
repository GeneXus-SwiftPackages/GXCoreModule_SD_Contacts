...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.10.xcframework.zip",
			checksum: "63985597c3839534fabd07b86e0aa817ac65d6193890cb1cea56415e2fd15986"
		)
	]
)