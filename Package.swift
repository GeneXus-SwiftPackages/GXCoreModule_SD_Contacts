...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-4.2.0-beta.38.xcframework.zip",
			checksum: "0347ee16b84a0047053337dcd95824f92e89218baa5fd4376f1df64c9c85dae3"
		)
	]
)