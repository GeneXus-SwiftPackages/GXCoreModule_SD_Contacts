...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-1.2.0-beta.7.xcframework.zip",
			checksum: "81d703d02b1a055be31bcfe1dc8d12ac4a0d022a8461ac78a67fb1acba50fd7a"
		)
	]
)