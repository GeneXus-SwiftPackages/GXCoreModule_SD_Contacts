...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Contacts-2.0.0-beta.36.xcframework.zip",
			checksum: "4d0eb77684699bd23f39156ef9693ecd33bf2f6b244d18383afc852192440e08"
		)
	]
)