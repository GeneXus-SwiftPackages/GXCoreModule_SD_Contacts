...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Contacts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Contacts-3.0.2.xcframework.zip",
			checksum: "af5dc5031cef427ad886ba1cf8f765d00179d209fd6fca7bbca0eb71e003f37e"
		)
	]
)